...
def generate_single_script(name, ra, dec, mag, priority, is_lot="False", Repeat=0, auto_exp=True, filter_input=None, exp_time=None, count=None, info=None):
    ...
    if auto_exp:
        ...
        elif isinstance(exposure_times, str) and exposure_times.startswith("Too faint to observe"):
...
def process_observation_request(data):
    ...
    for target in targets:
        ...
        from app.services.astro.coordinate_converter import convert_ra_decimal_to_hms, convert_dec_decimal_to_dms
